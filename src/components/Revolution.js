...
const Revolution = props => {
  ...
  return (
    <Grid item container>
      ...
      {/* End of 2nd Row Start of 3rd Row*/}
      <Grid
        item
        container
        direction='row'
      ...
      {/* End of 3rd Row Start of 4th Row*/}
      <Grid
        item
        container
        direction={matchesMD ? 'column' : 'row'}
      ...
      {/* End of 4th Row Start of 5th Row*/}
      <Grid
        item
        container
        direction={matchesMD ? 'column' : 'row'}
      ...
      {/* End of 5th Row Start of 6th Row*/}
      <Grid
        item
        container
        direction={matchesMD ? 'column' : 'row'}
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img src={design} alt='paint brush' width='100%'  style={{maxWidth: 1000}}/>
        </Grid>
      </Grid>
      {/* End of 6th Row Start of 7th Row*/}
      <Grid
        item
        container
        direction={matchesMD ? 'column' : 'row'}
      ...
      <Grid
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            src={build}
            alt='Tower crane next to a building under construction'
            style={{maxWidth: matchesMD ? 700 : 1000}}
            width='100%' 
          />
        </Grid>
      </Grid>
      {/* End of 7th Row Start of 8th Row*/}
      <Grid
        item
        container
        direction={matchesMD ? 'column' : 'row'}
      ...
      {/* End of 8th Row Start of 9th Row*/}
      <Grid
        item
        container
        direction={matchesMD ? 'column' : 'row'}
      ...
      {/* End of 9th Row Start of 10th Row*/}
      <Grid
        item
        container
        direction={matchesMD ? 'column' : 'row'}
